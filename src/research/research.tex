...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%написать про гаммы чуть осторожнее
$\gamma_{\text{spin} \, x} = 1/T_1$, $\gamma_{\text{spin} \, y} = 1/T_2$, $\gamma_{\text{spin} \, z} = 1/T_2$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%defines the pulse area $\theta = \int \Omega_R(t) \, dt$.
...
Our parametrs: $\Gamma = 50 \mu eV$, $T = 1 K$, $B = 5 T$, $\Delta = 50 \mu eV$, $\tau = 13 ps $, $\alpha = 0.2 ps $, $g = 25 \mu eV$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%написать про гарффики чуть осторожнее
\begin{figure}[t]
