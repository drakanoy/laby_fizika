...
We consider a negatively charged InAs/GaAs quantum dot (QD) with a resident
...
magnetic field $B_x$ applied in the Voigt geometry, perpendicular to the growth
axis.
...
where $\sigma$ denotes the heavy hole spin state $\left| \pm 3/2 \right>$, the two
electrons being bound in a spin singlet;
...
dynamics has to be supplemented by the dissipative terms of the Lindblad master
equation
...
The corresponding jump operator is the population inversion operator of the trion
transition,

\begin{gather}
    \hat{V}_{\text{phon}} = \sum_{\sigma = \uparrow, \downarrow}
    \left( \hat{d}^{\dag}_{\sigma} \hat{d}_{\sigma}
    - \hat{a}^{\dag}_{\sigma} \hat{a}_{\sigma} \right) , \qquad
...
The third channel is the dephasing of the resident electron spin, caused by the
fluctuating hyperfine field of the lattice nuclei.
It is described by the spin population difference operator
